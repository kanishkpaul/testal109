...
7. **Flat Autoregressive Decode Latency Verified**: ResonatorLM decode latency is completely flat across context lengths (~0.12 to 0.27 ms/token on Apple Silicon M5), whereas Transformer attention decode latency increases with context (2.07 ms at 2K to 2.58 ms at 8K).
